...
SOLUTION =     ENV['SOLUTION']     || "TypeGuesser.sln" 
...
MSBUILD15CMD = ENV['MSBUILD15CMD'] || "C:/Program Files (x86)/Microsoft Visual Studio/2017/Community/MSBuild/15.0/Bin/msbuild.exe"