...
{
    /// <summary>
    /// Describes the translation capability of an <see cref="Numerical"/> when assiging a proper C# Type to a collection of input strings.  For example "1" might be picked as a
